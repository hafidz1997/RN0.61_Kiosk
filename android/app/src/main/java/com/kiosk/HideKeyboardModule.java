...
public class HideKeyboardModule extends ReactContextBaseJavaModule {
    ...
    public void hideSoftKeyBoard() {
        ...
        InputMethodManager mInputMethodManager = (InputMethodManager) Assertions
                .assertNotNull(getReactApplicationContext().getSystemService(Context.INPUT_METHOD_SERVICE));
